...
const unsigned char *frames3[] = { cute1, cute2, cute3, cute4, cute5,cute6,cute7,happyidle1};
...
const unsigned framestime3[] = { 30, 30, 30, 30, 30, 30, 5000,5000,100};
const int totalFrames = sizeof(frames) / sizeof(frames[0]);
const int totalFrames3 = sizeof(frames3) / sizeof(frames3[0]);

  // Calculul numărului total de cadre din animația "idle"
...
int currentFrame2 = 0;
int currentFrame3 = 0;  // Indexul cadrului curent pentru animația de progres