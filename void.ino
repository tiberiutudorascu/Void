...
#include "DHT.h"              // Bibliotecă pentru senzorul DHT (temperatură și umiditate)
...
Adafruit_SSD1306 display(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, OLED_RESET); // Inițializează obiectul display cu parametrii specificați
...
const unsigned char *frames[] = {happyidle1, happyidle2, happyidle3, happyidle4, happyidle5, happyidle2, happyidle3};
